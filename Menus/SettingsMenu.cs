...
public class SettingsMenu : Container {
    ...
    Godot.HSlider masterVolumeSlider;
    Godot.TextEdit masterVolumeLabel;
    Godot.HSlider sfxVolumeSlider;
    Godot.TextEdit sfxVolumeLabel;
    Godot.HSlider musicVolumeSlider;
    Godot.TextEdit musicVolumeLabel;

    Godot.HSlider mouseXSlider;
    Godot.TextEdit mouseXLabel;
